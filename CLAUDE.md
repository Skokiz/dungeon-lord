...
Замість лінійних апгрейдів — сітка 3×3 (Тіло/Розум/Душа × Атака/Захист/Аура), 5 рівнів кожна клітинка. Платиться елітними душами. В UI — золоті орби `.esoul-gem` (CSS radial-gradient) замість emoji 💀.
